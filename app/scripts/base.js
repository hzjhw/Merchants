...
Application.prototype = {
  ...
  fixScroll: function (page) {
    var $content = $('.app-content', $(page));
    if ($content.size() > 0) {
      App.Scrollable($content.get(0), !!window['APP_FORCE_ISCROLL'])
    }
  },
  initPage: function (page, height) {
    ...
    /*setTimeout(function(){App.fixScroll(page);}, 0);
    setTimeout(function(){App.fixScroll(page);}, 100);
    setTimeout(function(){App.fixScroll(page);}, 1000);
    setTimeout(function(){App.fixScroll(page);}, 3000);*/
